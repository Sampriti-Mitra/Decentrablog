    ...
    const handleSubmit = (event) => {
        ...
        fetch("/api/blogs", {
            ...
            .then(response => {
                if (!response.success){
                    setStatus('');
                    let message = (response.error.title!==undefined)? "\nTitle:" + response.error.title + "\n" :"";
                    message  = message + ((response.error.subheading!==undefined)? "Subheading:" + response.error.subheading + "\n" :"");
                    message  = message + ((response.error.tags!==undefined)? "Tags:" + response.error.tags + "\n" :"");
                    message  = message + ((response.error.content!==undefined)? "Content:" + response.error.content + "\n" :"");
                            ...
                            <div className="container editArticleContainer">
                                ...
                                {status === 'minting' ? (
                                    <Box className="progress marginPadding">
                                        <div> <br/>Please wait, your blog is being minted!<br/></div>
                                        <br/>
